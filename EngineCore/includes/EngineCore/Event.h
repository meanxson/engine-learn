//
// Created by meanx on 15.03.2022.
//

#ifndef ENGINE_LEARN_EVENT_H
#define ENGINE_LEARN_EVENT_H
...
namespace Engine {
    ...
    struct EventWindowResize : public BaseEvent {
        EventWindowResize(const unsigned int new_width, unsigned int new_height)
